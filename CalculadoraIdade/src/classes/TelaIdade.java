...
public class TelaIdade extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnCalc.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/calculator-vector-icon-png_308914.jpg"))); // NOI18N
        ...
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/PSX_20200203_114918.jpg"))); // NOI18N

        jLabel3.setText("Na data de:");

        lblDataAtual.setText(Integer.toString(ano));
    ...
    Calendar dataHoje = GregorianCalendar.getInstance();/*Instancia objeto Calendar
(getInstance() é necessário porque Calendar é abstract).*/

        int ano = dataHoje.get(Calendar.YEAR);/*Obtém o ano
        atual registrado no sistema e o atribui à variável.*/
    
    private void btnCalcActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCalcActionPerformed
int nascimento = Integer.parseInt(txtAN.getValue().toString());
